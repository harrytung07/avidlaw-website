...
// Define the structure for multi-language content
...
Remmem v. Remmem, 2014 BCSC 1552
  ...
  {
    id: 11,
    category: "Real Estate", // Or Family Law - adjust if needed
    title: "Foreclosure in British Columbia: What Homeowners and Lenders Need to Know",
    date: "August 25, 2025", // Replace with actual date
    author: "Kun Dong", // Replace with actual author
    role: "Articling Student", // Replace with actual role
    image: "/article1.png", // Replace with actual image path
    preview: "Foreclosure is a legal process that allows a mortgage lender to recover money owed when a borrower falls behind on payments. In British Columbia, foreclosure is court-supervised and must go through the BC Supreme Court. ", // Replace with actual preview
    content:
    `Foreclosure in British Columbia: What Homeowners and Lenders Need to Know
不列颠哥伦比亚省（BC省）止赎程序简介：房主与贷款人的重要指南

Foreclosure is a legal process that allows a mortgage lender to recover money owed when a borrower falls behind on payments. In British Columbia, foreclosure is court-supervised and must go through the BC Supreme Court. Whether you’re a homeowner facing financial difficulties or a lender seeking repayment, understanding the foreclosure process is critical.
...
什么情况下会触发止赎？
Foreclosure typically begins when a borrower defaults on their mortgage—this could mean missed mortgage payments, unpaid property taxes, or a breach of mortgage terms. The lender usually starts by sending a demand letter giving the borrower a short window (often 10–30 days) to fix the default. If no resolution is reached, the lender can file a foreclosure petition in the BC Supreme Court.
止赎通常发生在借款人违约的情况下，比如连续未支付按揭款项、拖欠地税，或违反了贷款合同的其他条款。贷款人通常会先发出催款通知，要求借款人在10至30天内纠正违约行为。如果借款人未作出回应或未能补救违约，贷款人便可以向BC省最高法院提出止赎申请。

Step-by-Step: The Foreclosure Process
止赎流程概览
1.	Filing a Petition提交止赎申请
The lender (also called the “petitioner”) files a petition in court naming the borrower, tenants, and any other parties with an interest in the property (such as second mortgage holders).
贷款人（申请人）向法院递交请愿书，列明房产所有人、租户以及其他可能对房产拥有权益的相关方（如第二按揭持有人）。

2.	Order Nisi “初步裁定”
This is the first court order in a foreclosure proceeding. It confirms the amount owed and sets a redemption period—usually six months—giving the borrower time to repay the debt or arrange for a sale.
这是止赎程序中的首个法院命令。法院会确认借款金额，并设定一个“赎回期”（一般为六个月），在此期间房主可还清欠款或安排出售房产。

3.	Redemption Period 赎回期
During this time, the borrower can “redeem” the mortgage by paying off the full balance, including legal costs and interest. Many borrowers use this time to refinance or sell the property privately.
房主可以通过支付全部欠款（包括利息和法律费用）来赎回房产。许多房主也会利用此时间寻求再融资或私下出售房产。

4.	After the Redemption Period 赎回期后续处理
If the mortgage isn’t paid, the lender can ask the court for:
如果房主未能还款，贷款人可以申请：

o	Conduct of Sale: The court authorizes the lender (or a realtor) to sell the property under court supervision. Any surplus after debts are paid goes to other creditors or the borrower.
销售授权:法院授权贷款人或经纪人公开出售房产。售房所得在扣除债务和费用后，如有剩余，将返还给房主或其他债权人。

o	Order Absolute: In rare cases where the property has no equity and cannot be sold, the court may transfer ownership directly to the lender. This ends the borrower’s interest in the property.
绝对产权令: 在极少数情况下，如房产没有剩余价值且无法出售，法院可将产权直接转移给贷款人，终止房主对房产的所有权益。

Borrowers Still Have Rights
房主仍享有合法权利

Foreclosure doesn’t mean immediate loss of your home. Borrowers have important rights, including the right to redeem the mortgage and the opportunity to ask the court for more time to sell the property. The court will consider fairness and may deny a lender’s request if there’s still equity that could benefit the borrower.
止赎并不意味着房主立刻失去房屋。在整个过程中，房主仍享有赎回权，并可向法院申请延期出售以保留剩余资产价值。BC法院在处理止赎案件时会考虑公平性，若房产仍有净值，法院通常不会轻易将产权转给贷款人。

What About Deficiency Judgments? 关于“亏空判决”
If the property sells for less than the mortgage debt, the lender can seek a deficiency judgment against the borrower for the remaining balance—but only if the mortgage includes a personal covenant. In practice, many lenders do not pursue this if the borrower has no significant assets or has filed for bankruptcy.
如果房产出售所得不足以偿还全部贷款，贷款人可申请“亏空判决”，向借款人追讨差额。这仅适用于贷款合同中包含“个人还款承诺条款”的情况。实际上，许多贷款人不会选择追偿，特别是当借款人已经申请破产或资产有限时。

Why Legal Advice Matters 为什么应当尽早寻求法律意见？
Foreclosure law in BC is complex and highly procedural. For lenders, getting the process right is essential to recover funds efficiently. For borrowers, early legal advice can lead to more options—whether it’s negotiating with the lender, selling the property, or protecting remaining equity.
BC省的止赎法律程序复杂，且具有高度程序性。贷款人应确保程序合法合规，以有效收回贷款。对于房主而言，越早获得法律建议，越有可能争取到私下出售、协商还款或保留资产的机会。

At Avid Law, we assist both lenders and homeowners with foreclosure matters across British Columbia. Whether you need to enforce a mortgage or respond to a foreclosure petition, we're here to guide you through each step with clarity and care.
安胜.弘人律所拥有丰富的BC省止赎案件处理经验，无论您是贷款人还是房主，我们都能为您提供专业、高效的法律支持，助您稳妥应对每一步。

Need help with a foreclosure matter? Contact us today to schedule a consultation.
如需了解更多，请联系我们，预约咨询。
  ...
  },
  {
    id: 8,
    category: "Family Law",
    title: "Common Client Misconceptions (Prenuptial Agreements) / 常见客户误区清单（婚前协议篇）",
    date: "October 2, 2025",
    author: "Adele Sun",
    role: "Barrister & Solicitor",
    image: "/article4.png",
    preview: "Understanding the realities versus common misconceptions about prenuptial agreements in British Columbia. This article clarifies 8 crucial areas including children from previous relationships, property appreciation, foreign assets, income disclosure, spousal support waivers, family homes, gifts and inheritances, and the enforceability of agreements. 了解不列颠哥伦比亚省婚前协议的现实与常见误区。",
    content: `List of Common Client Misconceptions (Prenuptial Agreements)
常见客户户误区清单（婚前协议篇）

1. Regarding Children: A misconception is believing you have no financial obligation to a partner's children from a previous relationship.
子女相关：误区是以为一方从前一段关系带来的子女，自己没有抚养义务。

Reality: Under B.C.'s Family Law Act, if you act as a parent to your partner's child during your relationship, you may be required to pay child support upon separation.
现实：根据 B.C. 省《家庭法》，如果在同居期间，一方实质上扮演了另一方子女的父母角色，在分居时可能需要承担抚养费义务。

2. Increase in Property Value: A misconception is assuming that pre-relationship property and any growth in its value will automatically remain separate.
财产增值：误区是认为婚前个人财产永远是独立的，其增值部分也无需在协议中提及。

Reality: In B.C., the increase in the value of an asset that occurs during the relationship is presumptively considered family property.
现实：在 B.C. 省，婚前资产在关系存续期间的增值部分，默认为家庭财产。

3. Foreign Assets: A misconception is thinking that assets located outside of Canada do not need to be disclosed.
海外资产：误区是认为境外资产不需要向对方披露。

Reality: Full and honest financial disclosure is the foundation of a valid agreement.
现实：完整、诚实的财务披露是协议有效性的基石。

4. Income and Future Changes: A misconception is believing that current income does not need to be disclosed because it is subject to change.
收入与未来变化：误区是认为当前的收入不必披露，因为它将来会改变。

Reality: A complete picture of your financial circumstances at the time of signing, including income, must be disclosed.
现实：签署协议时的财务状况（包括收入）必须全面披露。

5. Waiver of Spousal Support: A misconception is believing that signing a spousal support waiver is a "100% risk-free" guarantee.
放弃配偶赡养费：误区是相信只要签署了放弃赡养费的条款，就"百分之百无风险"。

Reality: A court may still intervene if a significant change in circumstances makes the waiver significantly unfair in the future.
现实：如果未来情况发生极端变化导致协议条款变得极度不公平时，法院仍有权介入。

6. The Family Home: A misconception is thinking that if a property is registered only in one partner's name, it cannot be considered the "family home."
家庭住宅：误区是认为只要房产仅在一方名下，就自动不属于"家庭住宅"。

Reality: In B.C., a property that is ordinarily occupied by the couple is often treated as the family home, regardless of whose name is on the title.
现实：在 B.C. 省，无论房产证上是谁的名字，只要夫妻双方通常居住于此，该房产就可能被认定为家庭住宅。

7. Gifts and Inheritances: A misconception is assuming that personal gifts or inheritances do not need to be addressed in the agreement.
礼物与继承：误区是以为个人获得的继承或赠与财产无需在协议中处理。

Reality: While generally excluded property, they can be converted into family property if commingled into joint accounts or used to purchase joint assets.
现实：虽然这些资产原则上是独立财产，但如果将其存入联名账户或用来购买共同房产，就可能被"转化"为家庭财产。

8. Invincibility of the Agreement: A misconception is thinking that once an agreement is signed, it is "ironclad" and cannot be challenged.
协议的绝对性：误区是以为协议一旦签署，就"牢不可破"，在任何情况下都不能被挑战。

Reality: A court can set aside or modify an agreement if it was procured unfairly, such as through a lack of independent legal advice or under duress.
...
export default function Articles() {
  ...
  const filteredArticles = selectedCategory === "All Categories"
    ? allArticlesData
    : allArticlesData.filter(article => getLocalizedContent(article.category) === selectedCategory);

  // Categories for the pills (derived from articles data)
  const categories = ["All Categories", ...Array.from(new Set(allArticlesData.map(article => getLocalizedContent(article.category))))];
                ...
                {filteredArticles.map((article) => (
                  <div key={article.id} className="rounded-xl overflow-hidden shadow-lg bg-gray-100 flex flex-col">
                    <div className="relative group">
                      ...
                      >
                        <span>{getLocalizedContent(article.title)}</span> {/* Wrap title in span for vertical centering if needed */}
                      </h3>
