...
// ==========================================
// 1. PASTE YOUR ARTICLES ARRAY BELOW
// ==========================================
const articles = [
    {
      id: 1,
...
// 2. CONFIGURATION
// ==========================================
// This will create a folder named "extracted_articles"
...
// Helper to escape double quotes in YAML values to prevent errors
...
// 3. EXECUTION
// ==========================================
console.log(`Starting extraction of ${articles.length} articles...`);
...
role: "${escapeYaml(article.role)}"
preview: "${escapeYaml(article.preview)}"
